...
public class Data {
	 ...
	 */
	public static List<ExampleLC> readEarthquakeDataFromFile(String filename) throws IOException {
		List<ExampleLC> examples = new ArrayList<ExampleLC>();
		Scanner in = new Scanner(new File(filename));
		while (in.hasNext()) {
			ExampleLC example = new ExampleLC(3);
	 ...
	 * Remember that we need to ensure that x_0=1.0 (AIMA p. 721).
	 */
	public static List<ExampleLC> readFromFile(String filename) throws IOException {
		...
		while (!done) {
			...
			case StreamTokenizer.TT_EOL:
				...
				ExampleLC example = new ExampleLC(nvalues);
